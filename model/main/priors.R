...
config$prior_type$beta0 <- "uniform"
...
config$prior_max$beta0 <- 0.05
config$prior_max$epsilon <- 1

## Seeds
seed1 <- list(alpha=0.1, lag=100, epsilon=0.3, beta0=0.01, phi0=0.3, phi1=0.8)
seed2 <- list(alpha=0.3, lag=60,  epsilon=0.5, beta0=0.015, phi0=0.2, phi1=0.5)
seed3 <- list(alpha=0.2, lag=80,  epsilon=0.7, beta0=0.02, phi0=0.1, phi1=0.4)
